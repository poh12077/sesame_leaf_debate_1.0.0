! function(t, e) {
    ...
    var t = {
        ...
        y = c.helpers;
    c.defaults.global.plugins.doughnutlabel = t, c.plugins.register({
        id: "doughnutlabel",
                ...
                if (i && i.labels && 0 < i.labels.length) {
                    ...
                    i.labels.forEach(function(t) {
                        var e = {
                            ...
                            color: o([t.color, i.color, c.defaults.global.defaultFontColor], l, 0)
                        };
                        a.push(e)
                    });
                    var t = p.textSize(l, a),
                        ...
                        r = 2 * n.innerRadius / e;
                    r < 1 && (a.forEach(function(t) {
                        t.font.size = Math.floor(t.font.size * r), t.font.lineHeight = void 0, t.font = p.parseFont(o([t.font, {}], l, 0))
                    }), t = p.textSize(l, a)), l.textAlign = "center", l.textBaseline = "middle";
                    var f, u = (n.chartArea.left + n.chartArea.right) / 2,
